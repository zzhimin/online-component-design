...
export declare class NzBackTopComponent implements OnInit, OnDestroy, OnChanges {
    ...
    constructor(doc: NzSafeAny, nzConfigService: NzConfigService, scrollSrv: NzScrollService, platform: Platform, cd: ChangeDetectorRef, zone: NgZone, cdr: ChangeDetectorRef, destroy$: NzDestroyService, directionality: Directionality);
    ngOnInit(): void;
    private getTarget;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<NzBackTopComponent, [null, null, null, null, null, null, null, null, { optional: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<NzBackTopComponent, "nz-back-top", ["nzBackTop"], { "nzTemplate": "nzTemplate"; "nzVisibilityHeight": "nzVisibilityHeight"; "nzTarget": "nzTarget"; "nzDuration": "nzDuration"; }, { "nzClick": "nzClick"; }, never, never, false, never>;
}
