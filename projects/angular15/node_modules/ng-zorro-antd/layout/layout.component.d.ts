...
export declare class NzLayoutComponent implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<NzLayoutComponent, [{ optional: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<NzLayoutComponent, "nz-layout", ["nzLayout"], {}, {}, ["listOfNzSiderComponent"], ["*"], false, never>;
}
