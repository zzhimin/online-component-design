...
export declare type NzFormControlStatusType = 'success' | 'error' | 'warning' | 'validating' | '';
...
export declare class NzFormItemComponent implements OnDestroy, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzFormItemComponent, "nz-form-item", ["nzFormItem"], {}, {}, never, ["*"], false, never>;
}
