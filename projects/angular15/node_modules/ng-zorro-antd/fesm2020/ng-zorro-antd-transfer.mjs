...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.5", ngImport: i0, type: NzTransferComponent, decorators: [{
  ...
  `,
        ...
        }], ctorParameters: function () { return [{ type: i0.ChangeDetectorRef }, { type: i1$1.NzI18nService }, { type: i0.ElementRef }, { type: i0.Renderer2 }, { type: i2$2.Directionality, decorators: [{
                    type: Optional
