...
export declare class NzFormItemFeedbackIconComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzFormItemFeedbackIconComponent, "nz-form-item-feedback-icon", ["nzFormFeedbackIcon"], { "status": "status"; }, {}, never, never, false, never>;
}
export {};
