...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.5", ngImport: i0, type: NzFormDirective, decorators: [{
        ...
        return [{ type: i1.NzConfigService }, { type: i2.Directionality, decorators: [{
                        type: Optional
                    }] }];
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.5", ngImport: i0, type: NzFormControlComponent, decorators: [{
  ...
  `,
        ...
        return [{ type: NzFormItemComponent, decorators: [{
                        type: Optional
                    }, {
                        type: Host
...
class NzFormLabelComponent {
    ...
    get nzLabelAlign() {
        var _a;
        return this.labelAlign !== 'default' ? this.labelAlign : ((_a = this.nzFormDirective) === null || _a === void 0 ? void 0 : _a.nzLabelAlign) || 'right';
    }
    ngOnDestroy() {
        this.destroy$.next();
        this.destroy$.complete();
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.5", ngImport: i0, type: NzFormLabelComponent, decorators: [{
  ...
  `,
        ...
        return [{ type: i0.ChangeDetectorRef }, { type: NzFormDirective, decorators: [{
                        type: Optional
                    }, {
                        type: SkipSelf
                    }] }];
