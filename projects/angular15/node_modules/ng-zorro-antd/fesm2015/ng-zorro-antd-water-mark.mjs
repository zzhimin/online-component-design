...
class NzWaterMarkComponent {
    ...
    getFont() {
        ...
        this.nzFont = Object.assign(Object.assign({}, font), this.nzFont);
    ...
    getMarkStyle() {
        ...
        let positionLeft = ((_b = (_a = this.nzOffset) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : this.nzGap[0] / 2) - this.nzGap[0] / 2;
        let positionTop = ((_d = (_c = this.nzOffset) === null || _c === void 0 ? void 0 : _c[1]) !== null && _d !== void 0 ? _d : this.nzGap[1] / 2) - this.nzGap[1] / 2;
        if (positionLeft > 0) {
    ...
    appendWatermark(base64Url, markWidth) {
        ...
        this.waterMarkElement.setAttribute('style', getStyleStr(Object.assign(Object.assign({}, this.getMarkStyle()), { backgroundImage: `url('${base64Url}')`, backgroundSize: `${(this.nzGap[0] + markWidth) * BaseSize}px` })));
    ...
    getMarkSize(ctx) {
        ...
        return [(_a = this.nzWidth) !== null && _a !== void 0 ? _a : defaultWidth, (_b = this.nzHeight) !== null && _b !== void 0 ? _b : defaultHeight];
    }
...
NzWaterMarkModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.5", ngImport: i0, type: NzWaterMarkModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
NzWaterMarkModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.5", ngImport: i0, type: NzWaterMarkModule, declarations: [NzWaterMarkComponent], imports: [CommonModule], exports: [NzWaterMarkComponent] });
NzWaterMarkModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.5", ngImport: i0, type: NzWaterMarkModule, imports: [CommonModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.5", ngImport: i0, type: NzWaterMarkModule, decorators: [{
            type: NgModule,
            args: [{
