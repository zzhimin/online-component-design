...
import { BehaviorSubject, Subject, of, Observable, fromEvent, EMPTY } from 'rxjs';
import { distinctUntilChanged, withLatestFrom, map, takeUntil, startWith, switchMap } from 'rxjs/operators';
...
import { isNotNil, arraysEqual, toArray, getStatusClassNames, InputBoolean } from 'ng-zorro-antd/core/util';
...
class NzCascaderComponent {
    ...
    focus() {
        var _a;
        if (!this.isFocused) {
            (((_a = this.input) === null || _a === void 0 ? void 0 : _a.nativeElement) || this.el).focus();
            this.isFocused = true;
        }
    }
    blur() {
        var _a;
        if (this.isFocused) {
            (((_a = this.input) === null || _a === void 0 ? void 0 : _a.nativeElement) || this.el).blur();
            this.isFocused = false;
        }
    }
    handleInputBlur() {
...
NzCascaderComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.5", ngImport: i0, type: NzCascaderComponent, deps: [{ token: NzCascaderService }, { token: i2$1.NzConfigService }, { token: i0.NgZone }, { token: i0.ChangeDetectorRef }, { token: i3$1.NzI18nService }, { token: i4$1.NzDestroyService }, { token: i0.ElementRef }, { token: i0.Renderer2 }, { token: i5.Directionality, optional: true }, { token: i6.NzNoAnimationDirective, host: true, optional: true }, { token: i7.NzFormStatusService, optional: true }, { token: i7.NzFormNoStatusService, optional: true }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.5", ngImport: i0, type: NzCascaderComponent, decorators: [{
  ...
  `,
        ...
        return [{ type: NzCascaderService }, { type: i2$1.NzConfigService }, { type: i0.NgZone }, { type: i0.ChangeDetectorRef }, { type: i3$1.NzI18nService }, { type: i4$1.NzDestroyService }, { type: i0.ElementRef }, { type: i0.Renderer2 }, { type: i5.Directionality, decorators: [{
                        type: Optional
...
NzCascaderModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.5", ngImport: i0, type: NzCascaderModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
NzCascaderModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.5", ngImport: i0, type: NzCascaderModule, declarations: [NzCascaderComponent, NzCascaderOptionComponent], imports: [BidiModule,
        CommonModule,
        FormsModule,
        OverlayModule,
        NzOutletModule,
        ...
        NzNoAnimationModule,
        NzOverlayModule,
        NzFormPatchModule], exports: [NzCascaderComponent] });
NzCascaderModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.5", ngImport: i0, type: NzCascaderModule, imports: [BidiModule,
        CommonModule,
        FormsModule,
        OverlayModule,
        NzOutletModule,
        ...
        NzOverlayModule,
        NzFormPatchModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.5", ngImport: i0, type: NzCascaderModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        BidiModule,
