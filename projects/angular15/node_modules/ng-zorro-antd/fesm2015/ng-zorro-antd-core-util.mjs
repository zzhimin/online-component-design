...
function findExistNode(key, option = {}) {
    var _a;
    const container = getContainer(option);
    return Array.from(((_a = containerCache.get(container)) === null || _a === void 0 ? void 0 : _a.children) || []).find(node => node.tagName === 'STYLE' && node.getAttribute(getMark(option)) === key);
}
...
function updateCSS(css, key, option = {}) {
    ...
    newNode === null || newNode === void 0 ? void 0 : newNode.setAttribute(getMark(option), key);
    return newNode;
}
