...
export declare class NzMenuItemDirective implements OnInit, OnChanges, OnDestroy, AfterContentInit {
    ...
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<NzMenuItemDirective, [null, null, { optional: true; }, null, { optional: true; }, { optional: true; }, { optional: true; }]>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzMenuItemDirective, "[nz-menu-item]", ["nzMenuItem"], { "nzPaddingLeft": "nzPaddingLeft"; "nzDisabled": "nzDisabled"; "nzSelected": "nzSelected"; "nzDanger": "nzDanger"; "nzMatchRouterExact": "nzMatchRouterExact"; "nzMatchRouter": "nzMatchRouter"; }, {}, ["listOfRouterLink"], never, false, never>;
}
